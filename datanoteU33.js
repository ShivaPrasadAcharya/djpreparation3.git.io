...
**This isn't a fair choice—it's coercion.**
...
**Victim Input ≠ Victim Control**: Listen to victim, but YOU decide what justice requires
...
**A high conviction rate at the cost of justice is not an accomplishment—it's a moral failure.**
...
2. **What are you being asked to do?**
   - Present false evidence? → Cannot do
   - Prosecute weak case? → Judgment call
   - Seek unjust sentence? → Ethically problematic
...
If you're not willing to lose your job over principle, you may not have principles—you have preferences.
...
**This isn't one case—it's the entire system.**
...
*You'll be pressured—by victims, by police, by your boss, by the media, by politicians. They'll want you to file charges when you shouldn't. They'll want you to seek sentences that don't fit. They'll want you to win at all costs.*
...
**8. Take care of your mental health.** This job will break you if you let it. Therapy isn't weakness—it's maintenance.
...
*You explained to us—over and over—that the evidence supported life in prison but not death penalty. You explained the law. You told us you were seeking justice, not vengeance.*
...
3. **Meet with victim**
   ...
   - Help her understand this doesn't mean she wasn't assaulted—just that wrong person was convicted
...
When DNA clearly excludes the defendant, fighting exoneration is not just ethically wrong—it's monstrous.
...
- Defendant didn't confess—he denied involvement throughout
...
**Every charging decision, every plea offer, every disclosure, every trial—these are choices about your character.**
...
**The defendants in your courtroom, the victims seeking justice, the community you serve, your colleagues watching you, your children learning from you, history judging you—**
...
PLEA OF ALIBI  ⚖  (Evidentiary Doctrine — S.11 IEA / BSA 2023)
         ...
         │        ├── 1.1  Definition & Etymology (Latin: alibi = "elsewhere")
         │        ├── 1.2  Legal Character (Rule of evidence, not substantive defence)
         │        └── 1.3  Statutory Framework (IEA / BSA / BNSS / Nepal Acts)
         │
         ├── 2. BURDEN & STANDARD OF PROOF
         │        ├── 2.1  Two-Burden Framework
         │        │        ├── Legal Burden → Prosecution → Beyond Reasonable Doubt
         │        │        └── Evidential Burden → Accused → Balance of Probabilities
         │        ├── 2.2  Standard on Accused (Preponderance)
         │        └── 2.3  Critical Distinctions (Denial ≠ Alibi; Vague ≠ Valid)
         │
         ├── 3. LANDMARK CASES — INDIA
         │        ├── 3.1  Dudh Nath Pandey v. State of U.P. (1981) — Standard of proof
         │        ├── 3.2  Binay Kumar Singh v. State of Bihar (1997) — Plea in reply
         │        ├── 3.3  State of Maharashtra v. Narsingrao Pimple (1984) — Credibility
         │        ├── 3.4  Vijayee Singh v. State of U.P. (1990) — Denial ≠ Alibi
         │        └── 3.5  Mukesh v. State NCT (2017) — Modern standard
         │
         ├── 4. PROCEDURE & EVIDENCE
         │        ├── 4.1  When & How to Raise (BNSS 2023 S.330 — advance notice)
         │        ├── 4.2  Types of Evidence (Oral / Documentary / Electronic)
         │        ├── 4.3  Digital Alibi (CDR, GPS, CCTV, AI concerns)
         │        └── 4.4  Common Pitfalls (8 key failure points)
         │
         ├── 5. NEPAL & COMPARATIVE LAW
         │        ├── 5.1  Nepali Statutory Position (Evidence Act 2031 BS, Samarthana)
         │        └── 5.2  Cross-Jurisdictional Table (India / Nepal / UK / USA)
         │
         ├── 6. RECENT DEVELOPMENTS 2023–25
         │        ├── 6.1  BNSS 2023 S.330 — Advance notice (major change)
         │        └── 6.2  Deepfake & AI — Fabricated digital alibi risk
         │
         └── 7. PROBLEM SCENARIOS
...
(Beyond Reasonable Doubt)
         ↓  [Accused responds]
ACCUSED raises Plea of Alibi
Inconsistency under S.11 IEA / BSA 2023
BNSS 2023 S.330 — Advance Notice Required
         ↓  [Evidential burden shifts]
ACCUSED produces EVIDENCE
Witnesses · Documents · CDR · GPS · CCTV
         ↓  [Court evaluates]
COURT assesses on Balance of Probabilities
(Cumulatively with all prosecution evidence)
...
1. [Conceptual Foundation](#1-conceptual-foundation)
   - [1.1 Definition & Etymology](#11-definition--etymology)
   - [1.2 Legal Character](#12-legal-character)
   - [1.3 Statutory Framework](#13-statutory-framework)
2. [Burden & Standard of Proof](#2-burden--standard-of-proof)
   - [2.1 Two-Burden Framework](#21-two-burden-framework)
   - [2.2 Standard on Accused](#22-standard-on-accused)
   - [2.3 Critical Distinctions](#23-critical-distinctions)
3. [Landmark Cases — India](#3-landmark-cases--india)
4. [Procedure & Evidence](#4-procedure--evidence)
5. [Nepal & Comparative Law](#5-nepal--comparative-law)
6. [Recent Developments](#6-recent-developments-202325)
7. [Problem Scenarios](#7-problem-scenarios)
...
> **Key Concept:** Alibi derives from Latin: *alibi* = **"elsewhere."** The plea asserts the accused was at a *different place* at the material time — it denies **presence**, not the act itself.

- Alibi is a rule of **evidence (relevancy)**, not a substantive defence
- Creates an *inconsistency* with the prosecution's narrative
- When adequately proved, one of the **strongest defences** available
- **Key Distinction:** Alibi ≠ Admission + Excuse. Alibi = *"I was not there at all."*

### 1.2 Legal Character

- Rule of **relevancy** under Section 11 IEA (and S.11 BSA 2023) — not a statutory defence
- Does *not* shift the legal burden from prosecution — creates only an **evidential burden**
- Treated as a **plea in reply**: cannot be examined in isolation

### 1.3 Statutory Framework

| Jurisdiction | Provision | Content / Rule |
|---|---|---|
| India | S.11 IEA 1872 | Facts inconsistent with fact in issue are relevant |
| India | S.11 BSA 2023 | Retains relevancy rule under new code |
| India | S.103 IEA / S.107 BSA | Burden on person asserting special exceptions |
| India | S.330 BNSS 2023 | Mandatory advance notice of alibi before trial ★ New |
| Nepal | Evidence Act 2031 BS | Relevancy of alibi facts in criminal proceedings |
| Nepal | Muluki Criminal Code 2074 BS | Defence provisions in criminal trials |
...
|---|---|---|
| **Legal Burden** | Prosecution (always) | Beyond Reasonable Doubt |
| **Evidential Burden** | Accused (for alibi) | Balance of Probabilities |

> **Critical Rule:** The legal burden **never shifts** to the accused in a criminal case. If the prosecution fails to establish the accused's presence, the alibi need not even be examined — *Binay Kumar Singh (1997)*.

### 2.2 Standard on Accused

- Accused need **not** prove alibi beyond reasonable doubt
- Standard: **Balance of probabilities** (preponderance)
- A successful alibi raises a **reasonable doubt** — that doubt benefits the accused
- Court considers alibi evidence **cumulatively** with all prosecution evidence

### 2.3 Critical Distinctions

| Concept | Explanation |
|---|---|
| **Mere Denial ≠ Alibi** | "I didn't do it" is not alibi — requires positive evidence of presence elsewhere |
| **Vague Alibi** | Without specific time, place & persons → treated with judicial suspicion |
| **Fabricated Alibi** | False alibi can strengthen prosecution case (adverse inference) |
| **Interested Witnesses** | Family members receive lesser weight without independent corroboration |
| **Late Alibi** | Raised post charge-framing → viewed with suspicion by courts |

---

## 3. Landmark Cases — India

### 3.1 Dudh Nath Pandey v. State of U.P. (1981)

**Citation:** (1981) 2 SCC 166  
**Principle:** Alibi must be proved with certainty; courts must be vigilant of fabricated alibis.  
> *"The burden on the accused to prove alibi… is on the balance of probabilities."*  
**Significance:** Foundational — establishes the standard of proof for alibi.

### 3.2 Binay Kumar Singh v. State of Bihar (1997)

**Citation:** (1997) 1 SCC 283  
**Principle:** Prosecution must first establish presence. Alibi is a plea in reply.  
> *"If prosecution fails to establish presence, alibi need not even be examined."*  
**Significance:** Clarifies the sequence — prosecution proves presence first, then alibi is tested.

### 3.3 State of Maharashtra v. Narsingrao Gangaram Pimple (1984)

**Citation:** (1984) 1 SCC 446  
**Principle:** Alibi witnesses must be credible. Interested witnesses receive lesser weight. Independent corroboration is essential.

### 3.4 Vijayee Singh v. State of U.P. (1990)

**Citation:** (1990) 3 SCC 190  
**Principle:** Mere denial of presence is not alibi. Accused must produce substantive, positive evidence of being elsewhere.

### 3.5 Mukesh v. State (NCT of Delhi) — Nirbhaya Case (2017)

**Citation:** (2017) 6 SCC 1  
**Principle:** Modern reiteration — alibi standards consistent regardless of gravity of offence.  
> *"The plea of alibi must be proved by cogent, reliable, and positive evidence."*

---

## 4. Procedure & Evidence

### 4.1 When & How to Raise Alibi

> **★ BNSS 2023 S.330 — New Requirement:** Accused must give advance written notice of alibi particulars (place, time, witness names & addresses) to the court and prosecution **before the trial begins**. Failure may be used adversely.

- Must be raised at the **earliest possible opportunity**
- Late introduction viewed with judicial suspicion
- Under the old IEA/CrPC regime: no formal notice was required
...
ALIBI EVIDENCE TYPES
         ...
         ├── 📄 DOCUMENTARY      → Tickets, hotel records, attendance registers
         ├── 🏥 MEDICAL          → OPD slips, prescriptions, admission records
         ├── 🛣️  TOLL / TRANSIT   → Toll records, railway passenger lists
         ├── 📱 CDR / PHONE      → Call Detail Records — tower pinging / location
...
DIGITAL ALIBI EVIDENCE
         ...
         │        └── Shows phone tower location — NOT physical location of accused
         │        └── Prosecution may argue: phone ≠ person
         ├── CCTV Footage
         │        └── Authentication mandatory under S.65B IEA / BSA 2023
         ├── GPS / Social Media
         │        └── High Courts increasingly accepting as corroborative evidence
         └── ⚠ EMERGING RISKS — AI / Deepfakes
...
1. Alibi only through family members (interested witnesses)
2. Contradictions in witness timing
3. Failure to cross-examine prosecution on identification
4. Belated alibi raised after charge framing
5. Vague — no specific time / place / persons
6. No documentary corroboration
7. False alibi → adverse inference (backfires)
8. No advance notice under BNSS 2023 S.330

---

## 5. Nepal & Comparative Law

### 5.1 Nepali Statutory Position

> Nepal follows broadly similar principles to India (shared common law heritage). The principle of *Samarthana* (corroboration) is significant. Alibi must be raised at District Court level.

| Instrument | Relevance |
|---|---|
| Muluki Criminal Code Act 2074 BS | Substantive criminal law; defence provisions |
| Evidence Act 2031 BS | Relevancy and admissibility of alibi evidence |

### 5.2 Cross-Jurisdictional Comparison

| Issue | India | Nepal | UK | USA |
|---|---|---|---|---|
| Statutory basis | S.11 IEA / BSA 2023 | Evidence Act 2031 BS | Common law | Rule 12.1 FRCP |
| Advance notice? | Yes — BNSS 2023 S.330 | No formal requirement | No | Yes (mandatory) |
| Standard on accused | Balance of probabilities | Balance of probabilities | Evidential burden only | Preponderance |
| Electronic evidence | S.65B IEA / BSA 2023 | Evidence Act 2031 BS | Similar authentication | Fed. Rules of Evidence |
| False alibi effect | Adverse inference | Adverse inference | Similar | Similar |
...
OLD REGIME (IEA + CrPC 1973)
         ...
         └── Authentication of electronic evidence under S.65B IEA

NEW REGIME (BSA + BNSS 2023)
         ├── S.330 BNSS 2023 — Advance notice of alibi NOW MANDATORY
         │        ├── Must disclose: date, time, place, witness names & addresses
         │        └── Failure = adverse use against accused at trial
...
> **⚠ Emerging:** Courts are beginning to grapple with AI-generated fabricated CCTV, manipulated GPS metadata, and synthetic audio/video as alibi evidence. Forensic certification and expert witnesses are becoming increasingly critical.
...
**Facts:** Ram is charged with robbery at a Delhi market at 3:00 PM on 15 January. He claims he was in Lucknow attending a wedding. He produces two relatives and a photographer as witnesses. The photographer's register shows the date, but Ram's name does not appear in any hotel register.

**Issues:**
- Are the relatives "interested witnesses"? What weight should they receive?
- Does the photographer's register satisfy documentary corroboration?
- Absence from hotel register — does this weaken the alibi?
- Apply: *Dudh Nath Pandey* (standard) + *Narsingrao Pimple* (credibility)

### 7.2 Problem B — Intermediate

**Facts:** Sita is accused of murder in Kathmandu. She claims she was in Pokhara at the material time. Her mobile phone data shows the phone pinging a tower in Pokhara. The prosecution argues the phone could have been with someone else.

**Issues:**
- Evidentiary value of CDR/tower data as alibi evidence?
- How does the prosecution rebuttal (phone ≠ person) affect the alibi?
- Apply Nepal's Evidence Act 2031 BS and Samarthana (corroboration) principle

### 7.3 Problem C — Advanced (Three Co-Accused)

**Facts:** Three accused are jointly charged with a terrorist act. Accused A proves he was abroad (passport stamped). Accused B claims alibi but witnesses turn hostile. Accused C raises no alibi.

| Accused | Situation | Key Questions |
|---|---|---|
| **A** | Passport stamped — strong alibi | Does A's alibi benefit B & C? Effect on common intention (S.34 IPC)? |
| **B** | Alibi raised, witnesses hostile | Does hostile testimony destroy alibi? Adverse inference? |
| **C** | No alibi raised | Does silence create adverse inference? Effect of joint trial? |

**Further Issues:**
- Does A's acquittal affect conviction of B and C on common intention?
- Apply: *Binay Kumar Singh* + BNSS 2023 S.330
...
| Resource | Focus Area |
|---|---|
| Ratanlal & Dhirajlal, *Law of Evidence* (latest ed.) | S.11 IEA — alibi and relevancy |
| Sarkar on Evidence | Alibi and inconsistent facts |
| Avtar Singh, *Principles of the Law of Evidence* | Comprehensive evidence law |
| Justice K.T. Thomas, *Evidence Act Commentary* | Case-by-case analysis |
| Bare Acts | IEA 1872 · BSA 2023 · BNSS 2023 · Nepal Evidence Act 2031 BS · Muluki Criminal Code 2074 BS |
...
| Type | Task |
|---|---|
| Essay (2000 words) | "Plea of alibi under Indian law — a rule of evidence or a substantive defence?" |
| Moot Court | Prosecution vs. Defence on Problem C (three co-accused) |
| MCQ Quiz | Burden of proof, key cases, statutory provisions under IEA and BSA |
| Comparative Paper | Alibi law in India vs. Nepal vs. one common law jurisdiction |
| Case Analysis | Critically analyse *Mukesh v. State NCT* on alibi standards |

---

*Notes prepared for LLM students · India & Nepal · Criminal Law & Evidence*
*Covers IEA 1872 · BSA 2023 · BNSS 2023 · Nepal Evidence Act 2031 BS · Muluki Criminal Code 2074 BS*
...
`;
window.noteU33Meta = { 
  name: "Criminal Procedural Law-prosecutorial Ethics",
  emoji: "📄"
};
